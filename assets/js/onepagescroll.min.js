function onePageScroll(e, t) {
    ...
    this.init = function () {
        ...
        if (i.pagination == true) {
            ...
            t.innerHTML = h;
            var n =
                (document.querySelector(".onepage-pagination").offsetHeight /
                    2) *
                -1;
    ...
    _init_scroll = function (e, t) {
        ...
        if (n < 0) {
            ...
            setTimeout(() => {
                ...
                const featureHead = document.querySelector(
                    ".feature-section.active .feature-head"
                );
                const featureImg = document.querySelector(
                    ".feature-section.active .feature-head + div"
                );
                const featureText = document.querySelector(
                    ".feature-section.active .feature-text"
                );

                if (featureSection.classList.contains("alt")) {
                    featureHead.classList.remove("animate__fadeOutUpBig");
                    featureImg.classList.remove("animate__fadeOutRight");
                    featureText.classList.remove("animate__fadeOutLeft");
                    featureHead.classList.add("animate__fadeInDownBig");
                    featureImg.classList.add("animate__fadeInRight");
                    featureText.classList.add("animate__fadeInLeft");
                } else {
                    featureHead.classList.remove("animate__fadeOutUpBig");
                    featureImg.classList.remove("animate__fadeOutLeft");
                    featureText.classList.remove("animate__fadeOutRight");
                    featureHead.classList.add("animate__fadeInDownBig");
                    featureImg.classList.add("animate__fadeInLeft");
                    featureText.classList.add("animate__fadeInRight");
                }
            }, 50);
        } else {
            moveUp(s);
            ...
            setTimeout(() => {
                ...
                const featureHead = document.querySelector(
                    ".feature-section:not(.active) .feature-head"
                );
                const featureImg = document.querySelector(
                    ".feature-section:not(.active) .feature-head + div"
                );
                const featureText = document.querySelector(
                    ".feature-section:not(.active) .feature-text"
                );

                if (featureSection.classList.contains("alt")) {
                    featureHead.classList.remove("animate__fadeInDownBig");
                    featureImg.classList.remove("animate__fadeInRight");
                    featureText.classList.remove("animate__fadeInLeft");
                    featureHead.classList.add("animate__fadeOutUpBig");
                    featureImg.classList.add("animate__fadeOutRight");
                    featureText.classList.add("animate__fadeOutLeft");
                } else {
                    featureHead.classList.remove("animate__fadeInDownBig");
                    featureImg.classList.remove("animate__fadeInLeft");
                    featureText.classList.remove("animate__fadeInRight");
                    featureHead.classList.add("animate__fadeOutUpBig");
                    featureImg.classList.add("animate__fadeOutLeft");
                    featureText.classList.add("animate__fadeOutRight");
                }
            }, 50);
        }
        l = r;
    ...
    this.moveDown = function (e) {
        ...
        if (!r) {
            if (i.loop == true) {
                pos = 0;
                r = document.querySelector(
                    i.sectionContainer + "[data-index='1']"
                );
            } else {
                return;
            }
